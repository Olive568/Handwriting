# -*- coding: utf-8 -*-
"""handwriting-recognition-using-crnn-in-keras.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14ufGfeGY8_OVUBCPyyce_Q9HhX35yVO9
...
train = pd.read_csv("C:\\Users\\Luis Oliver\\Datasets\\written_name_train_v2.csv")
valid = pd.read_csv("C:\\Users\\Luis Oliver\\Datasets\\written_name_validation_v2.csv")

plt.figure(figsize=(15, 10))

for i in range(6):
    ax = plt.subplot(2, 3, i+1)
    img_dir = "C:\\Users\\Luis Oliver\\Datasets\\train_v2\\train\\"+train.loc[i, 'FILENAME']
...
for i in range(6):
    ax = plt.subplot(2, 3, i+1)
    img_dir = "C:\\Users\\Luis Oliver\\Datasets\\train_v2\\train\\"+unreadable.loc[i, 'FILENAME']
    image = cv2.imread(img_dir, cv2.IMREAD_GRAYSCALE)
    plt.imshow(image, cmap = 'gray')
...
for i in range(valid_size):
    img_dir = "C:\\Users\\Luis Oliver\\Datasets\\validation_v2\\validation\\"+valid.loc[i, 'FILENAME']
    image = cv2.imread(img_dir, cv2.IMREAD_GRAYSCALE)
    image = preprocess(image)
    image = image/255.
...
model_final.compile(loss={'ctc': lambda y_true, y_pred: y_pred}, optimizer=opt)
...
test = pd.read_csv("C:\\Users\\Luis Oliver\\Datasets\\written_name_test_v2.csv")

plt.figure(figsize=(15, 10))
for i in range(6):
    ax = plt.subplot(2, 3, i+1)
    img_dir = "C:\\Users\\Luis Oliver\\Datasets\\test_v2\\test\\"+test.loc[i, 'FILENAME']
    image = cv2.imread(img_dir, cv2.IMREAD_GRAYSCALE)
    plt.imshow(image, cmap='gray')
